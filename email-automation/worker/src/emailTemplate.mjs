export function renderWelcomeEmailHtml(name) {
  ...
  <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 480px; margin: 0 auto; background: #fff7ec; padding: 32px 28px; border-radius: 16px;">
    ...
    <p style="font-size: 16px; color: #1a1a1a; line-height: 1.5;">Dear ${escapeHtml(safeName)},</p>
...
export function renderWelcomeEmailText(name) {
  const safeName = name || 'Traveller';
