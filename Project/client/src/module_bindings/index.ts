...
import TombstoneRow from "./tombstone_table";
...
const tablesSchema = __schema({
  tombstone: __table({
    name: 'tombstone',
    indexes: [
      { accessor: 'id', name: 'tombstone_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'tombstone_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, TombstoneRow),
});
...
const reducersSchema = __reducers(
  __reducerSchema("bury", BuryReducer),
);
