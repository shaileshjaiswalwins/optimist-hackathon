...
import MarkPlayerReadyReducer from "./mark_player_ready_reducer";
...
import MatchStartGateRow from "./match_start_gate_table";
...
import PlayerReadyRow from "./player_ready_table";
...
const tablesSchema = __schema({
  ...
  matchStartGate: __table({
    name: 'match_start_gate',
    indexes: [
      { accessor: 'match_id', name: 'match_start_gate_match_id_idx_btree', algorithm: 'btree', columns: [
        'matchId',
      ] },
    ],
    constraints: [
      { name: 'match_start_gate_match_id_key', constraint: 'unique', columns: ['matchId'] },
    ],
  }, MatchStartGateRow),
  obstacle: __table({
    name: 'obstacle',
  ...
  playerReady: __table({
    name: 'player_ready',
    indexes: [
      { accessor: 'match_id', name: 'player_ready_match_id_idx_btree', algorithm: 'btree', columns: [
        'matchId',
      ] },
      { accessor: 'player_id', name: 'player_ready_player_id_idx_btree', algorithm: 'btree', columns: [
        'playerId',
      ] },
    ],
    constraints: [
      { name: 'player_ready_player_id_key', constraint: 'unique', columns: ['playerId'] },
    ],
  }, PlayerReadyRow),
...
type __SchemaWithTableAccessorAliases = Omit<typeof tablesSchema.schemaType, "tables"> & {
  tables: typeof tablesSchema.schemaType.tables & {
    ...
    /** @deprecated Use `matchStartGate` instead. This alias will be removed in the next major version. */
    readonly "match_start_gate": Omit<typeof tablesSchema.schemaType.tables["matchStartGate"], "accessorName"> & { readonly accessorName: "match_start_gate" };
    ...
    /** @deprecated Use `playerReady` instead. This alias will be removed in the next major version. */
    readonly "player_ready": Omit<typeof tablesSchema.schemaType.tables["playerReady"], "accessorName"> & { readonly accessorName: "player_ready" };
...
const tableAccessorAliases = {
  ...
  "match_start_gate": "matchStartGate",
