...
export const MatchPhaseSchedule = __t.object("MatchPhaseSchedule", {
  scheduledId: __t.u64(),
  scheduledAt: __t.scheduleAt(),
  matchId: __t.u64(),
  phase: __t.string(),
});
export type MatchPhaseSchedule = __Infer<typeof MatchPhaseSchedule>;

export const MatchStartGate = __t.object("MatchStartGate", {
  matchId: __t.u64(),
  preparationDeadline: __t.timestamp(),
  countdownStartedAt: __t.option(__t.timestamp()),
  raceStartsAt: __t.option(__t.timestamp()),
});
export type MatchStartGate = __Infer<typeof MatchStartGate>;
...
export const PlayerReady = __t.object("PlayerReady", {
  playerId: __t.u64(),
  matchId: __t.u64(),
  ready: __t.bool(),
  eligible: __t.bool(),
...
export type PlayerReady = __Infer<typeof PlayerReady>;
